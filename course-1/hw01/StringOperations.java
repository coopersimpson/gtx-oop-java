...
public class StringOperations  {
    ...
    public static void main(String[] args) {
        String myName = "aaaaCooperIfasABaddy3444";
        ...
        int indexTmp = webAddress.indexOf(".");
        webAddress = webAddress.substring(indexTmp + 1);
        indexTmp = webAddress.indexOf(".");
        webAddress = webAddress.substring(0, indexTmp);
        webAddress = webAddress + "1331";
        System.out.println(webAddress);
}
}
